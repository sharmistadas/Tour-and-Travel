...
export const MOCK_CATEGORIES = [
  ...
  },
  {
    ...
    name: "Adventure",
    slug: "adventure",
    description: "Thrilling adventure stories",
    postCount: 8,
  },
  {
    _id: "c4",
...
export const MOCK_POSTS = [
  {
    ...
    excerpt:
      "Discover the most stunning hidden beaches across Southeast Asia that most tourists never find.",
    featured_image: {
      url: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=600",
      alt: "Tropical beach",
      caption: "Hidden beach in El Nido",
      public_id: "beach1",
      width: 600,
      height: 400,
      format: "jpg",
    ...
    meta_description:
      "Explore the most beautiful hidden beaches in Southeast Asia. From secret coves to pristine shores.",
    view_count: 3842,
    is_featured: true,
    images_in_content: [
      {
        public_id: "img1",
        url: "https://images.unsplash.com/photo-1519046904884-53103b34b206?w=300",
        alt: "Beach sunset",
        position: 1,
      },
    ],
  ...
  {
    _id: "2",
    title: "Essential Hiking Gear for Mountain Adventures",
    ...
    excerpt:
      "A comprehensive guide to essential hiking gear for your next mountain adventure.",
    featured_image: {
  ...
  {
    _id: "3",
    title: "Budget-Friendly European Road Trip Itinerary",
    slug: "budget-friendly-european-road-trip",
    content_markdown:
      "# European Road Trip\n\nExplore Europe without breaking the bank...",
    excerpt:
      "Plan an unforgettable European road trip on a budget with our detailed itinerary.",
    featured_image: {
      url: "https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?w=600",
      alt: "Road trip",
      caption: "European countryside",
      public_id: "road1",
    },
    author: "a3",
    categories: ["c5", "c2"],
  ...
  },
  {
    ...
    status: POST_STATUS.PUBLISHED,
    published_at: new Date("2025-01-12"),
    meta_title: "Best Bangkok Night Markets & Street Food Guide",
    meta_description:
      "Discover the best street food spots in Bangkok's famous night markets.",
    view_count: 5214,
    is_featured: false,
    images_in_content: [],
  ...
  },
  {
    ...
    excerpt:
      "Explore the most exclusive safari lodges in Kenya for an unforgettable African adventure.",
    featured_image: {
      url: "https://images.unsplash.com/photo-1516426122078-c23e76b4f95b?w=600",
      alt: "Safari lodge",
      caption: "Luxury safari lodge in Masai Mara",
      public_id: "safari1",
    },
    author: "a2",
    categories: ["c6", "c2"],
    ...
    meta_description:
      "The best luxury safari lodges in Kenya for an unforgettable wildlife experience.",
    view_count: 1890,
    is_featured: true,
    images_in_content: [],
  ...
  {
    _id: "6",
    title: "Japan Cherry Blossom Season: Complete Guide",
    slug: "japan-cherry-blossom-season-guide",
    content_markdown:
      "# Cherry Blossom Season\n\nSpring in Japan is magical...",
    excerpt:
      "Everything you need to know about Japan's cherry blossom season including best viewing spots.",
    featured_image: {
  ...
  {
    _id: "7",
    title: "Mediterranean Cruise: Port-to-Port Highlights",
    slug: "mediterranean-cruise-port-highlights",
    content_markdown:
      "# Mediterranean Cruise\n\nSailing the Mediterranean is a dream...",
    excerpt:
      "A detailed port-by-port guide to the best Mediterranean cruise routes.",
    featured_image: {
      url: "https://images.unsplash.com/photo-1548574505-5e239809ee19?w=600",
      alt: "Cruise ship",
      caption: "Mediterranean cruise",
      public_id: "cruise1",
    },
    author: "a1",
    categories: ["c6", "c2"],
  ...
  {
    _id: "8",
    title: "Backpacking Through South America on $30/Day",
  ...
  },
  {
    ...
    excerpt:
      "Where and when to see the Northern Lights for the best experience.",
    featured_image: {
  ...
  {
    _id: "10",
    title: "Digital Nomad Guide: Working Remotely from Bali",
    slug: "digital-nomad-guide-bali",
    content_markdown:
      "# Digital Nomad in Bali\n\nBali has become a hub for remote workers...",
    excerpt:
      "Everything you need to know about living and working remotely from Bali.",
    featured_image: {
...
export function simpleMarkdownToHtml(md) {
  if (!md)
    return '<p class="ba-empty-preview">Start writing to see preview...</p>';
  let html = md
    .replace(/^### (.*$)/gm, "<h3>$1</h3>")
    .replace(/^## (.*$)/gm, "<h2>$1</h2>")
    .replace(/^# (.*$)/gm, "<h1>$1</h1>")
